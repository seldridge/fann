...
enum fann_layer_enum
{
	FANN_CONVOLUTIONAL_LAYER = 0,
	FANN_MAXPOOLING_LAYER,
	FANN_FCONNECTED_LAYER,
	FANN_INPUT_LAYER,
	FANN_OUTPUT_LAYER
};
...
/* Constant: FANN_TRAIN_NAMES
   ...
   See Also:
      <fann_train_enum>
*/
static char const *const FANN_LAYER_NAMES[] = {
	"FANN_CONVOLUTIONAL_LAYER",
	"FANN_MAXPOOLING_LAYER",
	"FANN_FCONNECTED_LAYER",
	"FANN_INPUT_LAYER",
	"FANN_OUTPUT_LAYER"
...
/* A single layer in the neural network.
 */
struct fann_layer_type
{

	enum fann_layer_enum type;
	unsigned int size;
