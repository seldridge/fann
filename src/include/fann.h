...
FANN_EXTERNAL struct fann *FANN_API fann_create_convolutional_array(float connection_rate, unsigned int num_layers,
...
FANN_EXTERNAL void FANN_API fann_add_layer_type(struct fann_layer_type *layers,
																		unsigned int i,
																		enum fann_layer_enum layer_type,
																		unsigned int size,
